import { A as AstroError, N as NoImageMetadata, U as UnsupportedImageFormat, q as MissingSharp } from './entrypoint_DfDWxQFi.mjs';
import { b as baseService, d as detector, r as resolveDefaultOutputFormat, p as parseQuality } from './generic_CaK-IMQj.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_DO5xxxSN.mjs').then(n => n.i)).default;
  } catch {
